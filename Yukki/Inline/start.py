...
def start_pannel():
    ...
    if not SUPPORT_CHANNEL and SUPPORT_GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="📨Support Group", url=f"t.me/riogroupsupport"
                ),
            ],
        ]
        return f"🎛  **This is {MUSIC_BOT_NAME}*", buttons
    if SUPPORT_CHANNEL and not SUPPORT_GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="📨Official Channel", url=f"t.me/rioprojects"
                ),
            ],
        ]
        return f"🎛  **This is {MUSIC_BOT_NAME}**", buttons
    ...
    if SUPPORT_CHANNEL and SUPPORT_GROUP:
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton(
                    text="📨Source Code", url=f"https://github.com/rioprojectx/rio-music"
                ),
            ],
        ]
        return f"🎛  **This is {MUSIC_BOT_NAME}**", buttons
